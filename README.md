...
[![Maintained](https://img.shields.io/badge/Maintained%3F-yes-green.svg)](https://github.com/ahunigel/reusable-workflows/graphs/commit-activity)
...
Replace `ahunigel/reusable-workflows` with your actual repository path.
